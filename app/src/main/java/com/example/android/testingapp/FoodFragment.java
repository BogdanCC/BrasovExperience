...
public class FoodFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        foods.add(new Places(getString(R.string.hockey_pub), getString(R.string.hockey_tags), R.drawable.gradient_a6_opacity_blue_purple, R.drawable.hockeypub,
        ...
        foods.add(new Places(getString(R.string.four_roses), getString(R.string.four_roses_tags), R.drawable.gradient_a6_opacity_purple_red, R.drawable.fourroses,
        ...
        foods.add(new Places(getString(R.string.bistro_larte), (getString(R.string.bistro_tags)), R.drawable.gradient_a6_opacity_red_yellow, R.drawable.bistro,
        ...
        foods.add(new Places((getString(R.string.dei_frati)), (getString(R.string.dei_frati_tags)), R.drawable.gradient_a6_opacity_blue_purple, R.drawable.deifrati,
        ...
        foods.add(new Places((getString(R.string.prato)), (getString(R.string.prato_tags)), R.drawable.gradient_a6_opacity_purple_red, R.drawable.prato,
        ...
        foods.add(new Places((getString(R.string.keller_steak_house)), (getString(R.string.keller_steak_tags)), R.drawable.gradient_a6_opacity_red_yellow, R.drawable.keller,
        ...
        foods.add(new Places((getString(R.string.vanilla_lounge)), (getString(R.string.vanilla_tags)), R.drawable.gradient_a6_opacity_blue_purple, R.drawable.vanilla,
        ...
        foods.add(new Places((getString(R.string.pizzeria_nonna)), (getString(R.string.pizzeria_nonna_tags)), R.drawable.gradient_a6_opacity_purple_red, R.drawable.pizzeria,
