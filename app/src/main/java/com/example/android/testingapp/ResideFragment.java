...
public class ResideFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        residePlaces.add(new Places("Toscana",
        ...
        residePlaces.add(new Places("Kronwell",
        ...
        residePlaces.add(new Places("Hotel Belfort",
        ...
        residePlaces.add(new Places("Bella Vista",
